 ...
 * @Version: 1.0
 */
public class ChicagoStyleCheesePizza2 extends Pizza {
    public ChicagoStyleCheesePizza2(){
        name = "Chicago Style Deep Dish Cheese2 Pizza";
        dough = "Extra Thick Crust Dough";
        sauce = "Plum Tomato Sauce";

        toppings.add("Shredded Mozzarella Cheese2");
    }
    void cut(){
